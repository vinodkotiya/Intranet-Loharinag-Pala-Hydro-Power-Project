<%@ Page Language="VB" AutoEventWireup="false" CodeFile="uploader.aspx.vb" Inherits="_Default" %>
...
</script><center> <a href="loader.aspx?requestedpage=hindi">हिन्दी में लिखना सिखें ??</a></center>
  ...
  <div id="vincontent">
    ...
    <blockquote class="style1">Use This Feature to Add the Circulars, Articles, News, 
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      <ContentTemplate >
        <asp:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="1" Height="497px" 
          Width="622px"  
          AutoPostBack="true" >
...
&nbsp;
          ...
          <asp:GridView ID="gvCirculars" runat="server" Height="109px" PageSize="5" 
           ...
           <asp:TabPanel runat="server" HeaderText="Feedback" ID="TabPanel4"     >
                <ContentTemplate >
                 ...
                 <b> You feedback and suggestion are very important to us. It will help us to update the intranet as per your requirement. So leave your comments here.</b>
          ...
          <asp:GridView ID="gvCirculars4" runat="server" Height="109px" PageSize="5" 
           ...
           <asp:TabPanel runat="server" HeaderText="Profile" ID="TabPanel7"     >
                <ContentTemplate >
                 <fieldset ><legend>Change your Password...</legend> 
                 
                     <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Size="8pt" 
                  ForeColor="#6666FF" 
                         Text="Please type to change your password."  Height="16px" 
                  Width="601px"></asp:Label>
                  <table> 
                   <tr><td>
                     <asp:Label ID="Label12" runat="server" 
                         Text="User Id:                                             " 
                         CssClass="vinlabel"></asp:Label>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  </td><td>   
                           <asp:TextBox
                         ID="txtUser" runat="server" CssClass="tbox" Width="89px"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                         ControlToValidate="txtUser" ErrorMessage="Enter your 6 digit employee no"></asp:RequiredFieldValidator>
                  
                         
                       </td>   </tr> <tr><td>

                          <asp:Label ID="Label13" runat="server" Text="Old Password: " 
                         CssClass="vinlabel"></asp:Label>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                     </td><td> <asp:TextBox
                         ID="txtOldPwd" runat="server" CssClass="tbox" MaxLength="50" 
                         ValidationGroup="pwdChange" TextMode="Password"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                         ControlToValidate="txtOldPwd" ErrorMessage="Enter your old password"></asp:RequiredFieldValidator>
                   
                        </td>   </tr> <tr>
                        <td>  <asp:Label ID="Label14" runat="server" Text="New Password: " 
                         CssClass="vinlabel"></asp:Label>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                     </td><td><asp:TextBox
                         ID="txtNewPwd" runat="server" CssClass="tbox" MaxLength="50" 
                         ValidationGroup="pwdChange" TextMode="Password"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                         ControlToValidate="txtNewPwd" ErrorMessage="Enter your new password"></asp:RequiredFieldValidator>
                       
                         </td> </tr> <tr> <td>
                          <asp:Label ID="Label15" runat="server" Text="Retype New Password: " 
                         CssClass="vinlabel"></asp:Label>
                    </td><td> <asp:TextBox
                         ID="txtRetype" runat="server" CssClass="tbox" MaxLength="50" 
                         ValidationGroup="pwdChange" TextMode="Password"></asp:TextBox>
                     <asp:CompareValidator ID="CompareValidator1" runat="server" 
                         ControlToCompare="txtNewPwd" ControlToValidate="txtRetype" 
                         ErrorMessage="New Password Mismatch Retype"></asp:CompareValidator>
                   
                     </td></tr> <tr> <td >
                     <asp:Button ID="btnChange" runat="server" Text="Change Password" 
                         ValidationGroup="pwdChange" UseSubmitBehavior="False" BorderColor="#009933" 
                              BorderStyle="Outset" BorderWidth="2px" CssClass="button" />
                     <br />
                 ...
                 <fieldset ><legend>Change Profile Pic...</legend> 
               <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Size="8pt" 
                    Text="Tip: Choose a picture which shows your face clearly. Use paintbrush to do this. If we do resizing during upload then u wont be happy. Select your new picture :<br/>"  Height="16px" 
                  Width="601px"></asp:Label> <br /> <br />
                     <asp:AsyncFileUpload ID="afuFile6" runat="server" UploaderStyle="Modern" 
                  CompleteBackColor="#0099CC" Font-Names="Arial" 
                  ForeColor="#0066FF" UploadingBackColor="#99FF99" 
                       FailedValidation="False"  />
             
                     <asp:Button ID="btnSubmit6" runat="server" BorderColor="#009933" 
                         BorderWidth="2px" CssClass="button" Text="Upload" CausesValidation="False" 
                         Enabled="False" ValidationGroup="pic" />
             
               <br />
              
        
              <asp:Label ID="lblBy6" runat="server" 
                  Text="Please authorize yourself by Signing in. click here to " 
                  Font-Bold="True" ForeColor="#0033CC" Font-Size="8pt"></asp:Label>
              <asp:HyperLink ID="lbSignin6" runat="server" 
                  NavigateUrl="login.aspx?requestedpage=uploader.aspx?mode=profile" 
                 Target="_self">Sign In</asp:HyperLink>
